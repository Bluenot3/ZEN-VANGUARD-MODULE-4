      ...
      subSections: [
        {
          ...
          content: [
            ...
            { type: 'paragraph', content: 'Users upload JSON or CSV schema exports from their micro-apps, and the tool generates a cinematic systems map — glassy neon nodes showing data flow, API dependencies, and latency trails. Each node pulses with color intensity based on average response time.' },
